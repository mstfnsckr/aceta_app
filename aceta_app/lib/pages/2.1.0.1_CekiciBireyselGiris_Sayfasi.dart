...
import '2.1.0.1.1_CekiciBireyselSifreYenile_Sayfasi.dart';

class CekiciGirisBireysel extends StatefulWidget {
  final String? ePosta;

  const CekiciGirisBireysel({super.key, this.ePosta});

  @override
  _CekiciGirisBireyselState createState() => _CekiciGirisBireyselState();
}

class _CekiciGirisBireyselState extends State<CekiciGirisBireysel> {
  ...
  Future<void> _girisYap() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://localhost:7187/api/Cekici/girisbireysel'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Bireysel Çekici Giriş', style: GoogleFonts.poppins()),
        centerTitle: true,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  const Icon(Icons.car_repair, size: 80, color: Colors.deepPurple),
                  const SizedBox(height: 20),
                  Text(
                    'Bireysel Çekici Girişi',
                    style: GoogleFonts.poppins(
                      fontSize: 24,
                    ...
                    Align(
                      ...
                      child: TextButton(
                        onPressed: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const CekiciGirisBireyselSifreYenileme(),
                          ),
                        ),
                        child: Text(
                          'Şifremi unuttum?',
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const CekiciKayitBireysel(),
                      ),
                    ),
                    child: Text(
                      'Kayıt Ol',
