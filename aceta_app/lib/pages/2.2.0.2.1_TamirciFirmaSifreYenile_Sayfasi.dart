import 'dart:convert';
import 'package:aceta_app/pages/2.2.0.2_TamirciFirmaGiris_Sayfasi.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:http/http.dart' as http;

class TamirciGirisFirmaSifreYenileme extends StatefulWidget {
  const TamirciGirisFirmaSifreYenileme({super.key});

  @override
  State<TamirciGirisFirmaSifreYenileme> createState() => _SifreYenilemeState();
}

class _SifreYenilemeState extends State<TamirciGirisFirmaSifreYenileme> {
  ...
  Future<void> _kodGonder() async {
    if (_ePostaController.text.isEmpty) {
      _showSnackBar('Lütfen firma e-posta adresinizi giriniz');
      return;
    }
  ...
  Future<void> _sifreyiYenile() async {
    ...
    final response = await http.post(
      Uri.parse('https://localhost:7187/api/Tamirci/sifreyiYenileFirma'),
      headers: {'Content-Type': 'application/json'},
      body: json.encode({
        'ePosta': _ePostaController.text,
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const TamirciGirisFirma()),
      );
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Tamirci Firma Şifre Yenile', style: GoogleFonts.poppins()),
        centerTitle: true,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(_ePostaController, "Firma E-Posta", Icons.business),
