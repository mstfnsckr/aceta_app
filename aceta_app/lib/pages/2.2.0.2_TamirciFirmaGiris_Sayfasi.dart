...
import '2.2.0.2.1_TamirciFirmaSifreYenile_Sayfasi.dart';
import '2.2.0.3_TamirciAna_Sayfasi.dart';
import '2.2.1.2_TamirciFirmaKayit_Sayfasi.dart';

class TamirciGirisFirma extends StatefulWidget {
  final String? ePosta;

  const TamirciGirisFirma({super.key, this.ePosta});
  
  @override
  _TamirciGirisFirmaState createState() => _TamirciGirisFirmaState();
}

class _TamirciGirisFirmaState extends State<TamirciGirisFirma> {
  ...
  Future<void> _girisYap() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://localhost:7187/api/Tamirci/girisfirma'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Firma Tamirci Giriş', style: GoogleFonts.poppins()),
        centerTitle: true,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  const Icon(Icons.build_circle, size: 80, color: Colors.deepPurple),
                  const SizedBox(height: 20),
                  Text(
                    'Firma Tamirci Girişi',
                    style: GoogleFonts.poppins(
                      fontSize: 24,
                    ...
                    Align(
                      ...
                      child: TextButton(
                        onPressed: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const TamirciGirisFirmaSifreYenileme(),
                          ),
                        ),
                        child: Text(
                          'Şifremi unuttum?',
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const TamirciKayitFirma(),
                      ),
                    ),
                    child: Text(
                      'Kayıt Ol',
